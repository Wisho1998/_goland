...
var file_messages_auth_proto_depIdxs = []int32{
	0, // 0: pb.AuthService.SingUp:input_type -> pb.User
	1, // 1: pb.AuthService.GerUser:input_type -> pb.GetUserRequest
	2, // 2: pb.AuthService.ListUser:input_type -> pb.ListUserRequest
	0, // 3: pb.AuthService.UpdateUser:input_type -> pb.User
	1, // 4: pb.AuthService.DeleteUser:input_type -> pb.GetUserRequest
	0, // 5: pb.AuthService.SingUp:output_type -> pb.User
	0, // 6: pb.AuthService.GerUser:output_type -> pb.User
	0, // 7: pb.AuthService.ListUser:output_type -> pb.User
